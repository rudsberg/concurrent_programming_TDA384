...
public class Lab1 {
	...
	public class Train implements Runnable {
		...
		/**
		 * Handles all releases of semaphores. They are only released if sensor becomes
		 * inactive.
		 * 
		 * @param se
		 */
		...
		/**
		 * Checks the given sensor event, x, y and if the train is headed the direction
		 * asked for (going north or south), if so the semaphore will be released.
		 */
